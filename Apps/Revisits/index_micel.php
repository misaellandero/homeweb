...
?>
	...
	<head>
      ...
      <!-- fin iconos -->
		...
		<!-- Meta Description -->
		<meta name="description" content="MicelStore iPhones nuevos originales baratos">
		<!-- Meta Keyword -->
         ...
         <a class="navbar-toggler navbar-brand py-2 " data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation" href="#">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
           ...
           <li class="nav-item dropdown">
            ...
            <li class="nav-item">
              <a class="nav-link" id="store-tab" data-toggle="tab" href="#store" role="tab" aria-controls="store" aria-selected="false"><i class="fas fa-mobile"></i> Mobiles</a>
            </li>
            <!-- <li class="nav-item">
...
<div class="modal fade" id="modal-terminos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     ...
     <!-- Modal datos terminos -->
						...
						<!--<div class=" text-right" style="position: fixed;
											...
											z-index:1000;
											">
										<a class="btn btn-primary" href="<?php echo $datosEmpresa[0]['mgn'];?>"  target="_blank"><i class="fab fa-facebook-messenger"></i> <span class="d-none d-lg-block">Envíanos un mensaje</span>		 </a>
										<a class="btn btn-success" href="<?php echo $datosEmpresa[0]['wtsp'];?>"  target="_blank"><i class="fab fa-whatsapp"></i>  <span class="d-none d-lg-block"> Envíanos un mensaje </span>	</a>
						</div> 
 						-->
<!-- tabs -->
	...
	<section class="top-course-area  section-gap" id="unique2">
										...
										<div class="row d-flex justify-content-center">
											...
											<div class="menu-content pb-60 col-lg-10">
												<div class="title text-center">
													...
													<p class="text-danger"><?php echo $datosTienda[0]['cabezara_texto'];?></p>
				    ...
				    <ul class="list-group sticky-top navbar-expand-lg navbar-dark " id="resultados_busqueda" > 
												...
												<div class="container">
													<h1 class="mb-10">Tu compra esta asegurada</h1> 
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
							<img src="sistema/images/icono_claro"  class="icon-claro d-inline-block align-top img-fluid" width="200em" alt="">
							<img src="sistema/images/icono_oscuro"  class="icon-oscuro d-inline-block align-top img-fluid" width="200em" alt="">
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								<h1 class="text-white mb-10">Opiniones de nuestros clientes</h1>
								<p class="text-white">Recopiladas de facebook</p>
							</div>
						</div>
					</div>						
					<div class="row">
