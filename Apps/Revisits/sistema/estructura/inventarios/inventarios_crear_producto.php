            ...
            <div class="modal-body">
              ...
              <form id="crearCampo">
                <div class="form-group">
                  ...
                  <select id="tipoDeCampo" class="form-control" name="tipoCampo">
                    <option value="0">Texto</option>
                    <option value="1">Numero</option>
                    <option value="2">Checkbox</option>
                    <option value="3">Listado</option>
                    <option value="4">Ingrediente extra</option>
                  </select>
                </div>
                ...
                <div id="precioCampo" class="form-group">
                  <label for="">Precio</label>
                  <input type="Number" class="form-control" name="precioCampo" hidde>
                </div>
