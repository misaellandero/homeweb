...
?>
	...
	<head>
	  ...
	  <!-- DropZones -->
		...
		<img src="sistema/images/icono_claro"  class="icon-claro animated infinite bounceIn" width="1%" alt="">
         ...
         <a class="navbar-toggler navbar-brand py-2 " data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation" href="#">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
           ...
           <!-- <li class="nav-item dropdown" >
              ...
              if($id_usuario < 1) {
                ...
                <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="sistema/php/login/log_out.php">
                      ...
                      <i class="fa fa-times-c ircle"></i> Salir</button>  
                  </a>
                </div>';
              }
              */?>
            ...
            <!-- <li class="nav-item">
              <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"><i class="fa fa-headset"></i> Contacto</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php// if($pedido != 0){echo 'active'; } ?>  boton_bolsa" id="bolsa-tab" data-toggle="tab" href="#bolsa" role="tab" aria-controls="bolsa" aria-selected="false"> <i class="fa fa-shopping-bag"></i> Bolsa </a>
            </li>
            <li class="nav-item">
...
<div class="modal fade" id="modal-terminos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     ...
     <!-- Modal datos terminos -->
						...
						<!--<div class=" text-right" style="position: fixed;
											...
											z-index:1000;
											">
										<a class="btn btn-primary" href="<?php echo $datosEmpresa[0]['mgn'];?>"  target="_blank"><i class="fa fa-facebook-messenger"></i> <span class="d-none d-lg-block">Envíanos un mensaje</span>		 </a>
										<a class="btn btn-success" href="<?php echo $datosEmpresa[0]['wtsp'];?>"  target="_blank"><i class="fa fa-whatsapp"></i>  <span class="d-none d-lg-block"> Envíanos un mensaje </span>	</a>
						</div> 
 						-->
<!-- tabs -->
					...
					<div class="tab-content" id="myTabContent">
						...
						<section class=".generic-banner unique-feature-area section-gap" id="unique2">
								<br>
								<br>
								<br>
								<br>
											...
											<div class="container">
												<div class="row align-items-center justify-content-center">
													<div class="col-lg-10">
														...
														<h1 class="text-white"><i class="fa fa-briefcase"></i>  Portafolio </h1>
														<br> 
			...
			<div class="container">
				...
				<h1 class="mb-10"><i class="fa fa-laptop-code"></i> Servicios</h1>
												...
												<div class="row align-items-center justify-content-center">
													<div class="col-lg-10">
														<div class="generic-banner-content">
																 ...
																 <?php  
																   if (($datosTienda[0]['modo_tienda']) == "tienda") {
																	echo '<h1 class="text-white"><i class="fa fa-store"></i>  Tienda </h1>';
																   } else {
																	echo '<h1 class="text-white"><i class="fa fa-briefcase"></i>  Portafolio </h1>';
																   } 
																 ?>
			...
			<br>
			<br>
				<h1 class="text-center mb-10"><i class="fa fa-instagram"></i> Instagram</h1>
            ...
            <div id="div_tabla_pedidos"></div>
				...
				<section class="generic-banner relative">	
												...
												<div class="row align-items-center justify-content-center">
													<div class="col-lg-10">
														<div class="generic-banner-content">
																...
																<h1 class="text-white"><i class="fa fa-headset"></i>  Contacto </h1>
					...
					<div class="container">
						<br>
						<h1 class="text-primary"><i class="fa fa-headset"></i>  Diferentes formas de ponernos en contacto </h1>
						...
						<a class="btn btn-primary" href="<?php echo $datosEmpresa[0]['mgn'];?>"  target="_blank"><i class="fa fa-facebook-messenger"></i> Envíanos un mensaje</a>
						<a class="btn btn-success" href="<?php echo $datosEmpresa[0]['wtsp'];?>"  target="_blank"><i class="fa fa-whatsapp"></i> Envíanos un mensaje</a>
						<br>
						<br>
						<h1 class="text-primary"><i class="fa fa-map-marker-alt"></i>  Visitanos </h1>
...
<div class=" text-right" style="position: fixed;
											...
											z-index:1000;
											">
									  <a class="btn btn-circle btn-info btn-lg mgn" style="" href="https://<?php echo $datosEmpresa[0]['mgn'];?>" target="_blank"><i class="fa fa-facebook-messenger"></i></a>
									  <a class="btn btn-circle btn-success btn-lg wtsp" style="" href="https://api.whatsapp.com/send?phone=<?php echo $datosEmpresa[0]['wtsp'];?>" target="_blank"><i class="fa fa-whatsapp"></i></a>
					 	</div
