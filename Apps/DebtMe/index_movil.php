...
?>
	...
	<head>
      ...
      <!-- fin iconos -->
		...
		<!-- Meta Description -->
		<meta name="description" content="MovilMX Celulares iPhone y Galaxy originales a un excelente precio">
		<!-- Meta Keyword -->
	  ...
	  <!-- DropZones -->
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			<link rel="stylesheet" href="watch/css/main.css">
    ...
    -->
		...
		<body> 	
		<div class="top-course-area section-gap pre-loader" style="background: #04091e"> 
...
if ($datosUsuario[0]['pedido'] == 1) {
 ...
 <nav class="  navbar-light bg-primary" style="text-align: center;">
 <span  class="navbar-text text-light">
 <?php echo $datosTienda[0]['cabezara_texto'];?>
 </span>
 
</nav>
		<header style="background: rgba(4, 9, 30, 0.9)" class="sticky-top" id="home">
...
<!-- tabs -->
					<div class="tab-content" id="myTabContent">
							...
							<div class="tab-pane fade show active" id="inicio" role="tabpanel" aria-labelledby="inicio-tab">
								...
								<div class="title text-center">
												...
												<div class="container">
													<h1 class="mb-10">¿Por qué comprar con nosotros?</h1>
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								<img src="sistema/images/icono"  class="d-inline-block align-top img-fluid" width="150em" alt="">
			...
			<div class="text-right" style="position: fixed;
				...
				<div class="container">
					<div class="row">
          			  ...
          			  <br>
									  <?php echo $datosEmpresa[0]['nombre'];?> Copyright &copy;<script>document.write(new Date().getFullYear());</script> | Todos los derechos reservados | This Web ssite is made by <a href="https://landercorp.mx" target="_blank">LanderCorp.mx</a>
									<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								</p>
