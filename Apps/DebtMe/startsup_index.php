        ...
        <div class="row"> 
          ...
          <div class="col-md-12 wow  fadeInRight " data-wow-duration="3s">
            <div class="px-md-5">
              ...
              <p>Configurar los productos y campos podria parecer un poco dificil al principio pero es lo que da flexibilidad a nuestro sistema.</p>
          ...
          <div class="col-md-8 wow fadeInLeft   " data-wow-duration="3s">
            <img src="sistema/images/imagen_promocional/documentacion/inventarios/articulos/articulos1.png" class="img-fluid floating">
          </div>
          <div class="col-md-4 wow  fadeInRight " data-wow-duration="3s">
            <div class="px-md-5">
              <hr class="line-success">
              <h2><i class="fa fa-pallet"></i> Crear un articulo nuevo </h2>  
              <p>Toca el botón <button id="boton_registrar_Articulo" type="button"  class="btn btn-sm btn-primary">Registrar Articulo <i class="fa fa-pallet"></i>  </button></p>
              <p>Selecciona a que familia de producto pertenecerá tu articulo </p>
              <p>Ingresa un nombre de articulo único para identificar tu articulo</p>
              <p>Ingresa una descripción corta con las características mas esenciales que quieras que vean tus clientes en tu tienda en linea </p>
              <p>En la descripción larga puedes ingresar texto con formato enriquecido e imágenes 
              <p>Ingresa un código único para tu producto, este puede ser un código de barras si deseas usar un lector en el punto de venta. 
              <p>Ingresa el SKU (opcional)
              <p>Ingresa el costo (cuanto te costo a ti el producto) si deseas tener un control de tu ganancias (opcional)
          ...
          <div class="col-md-12 wow  fadeInRight " data-wow-duration="3s">
            <div class="px-md-5">
              ...
              <p>Precio (ingresa el precio al publico de tu producto)
              <p>Precio anterior (opcional) ingresa un precio mayor a tu precio actual para mostrar como una oferta
              <p>Selecciona que impuesto lleva tu producto 
              <p>Selecciona si tu articulo se venderá en la tienda en linea o solo en el punto de venta
              <p>Sucursal (proximamente) 
              <p>Destacar en tienda elige si quieres que aparezca en la pagina principal si quieres que aparezca como oferta o si no quieres que aparezca (te recomendamos no destacar demasiados productos)
              <p>Existencia en inventario, esta existencia inicial se puede ingresar al momento de crear el producto, para modificarla después deberas usar  la sección movimientos.
              <p>Toca el botón  <button id="registrar_articulo" class="btn  btn-sm btn-info registrar_articulo"><i class="fa fa-save"></i> Guardar </button></p>
             </div>
          </div>
          <div class="col-md-4 wow fadeInLeft " data-wow-duration="3s">
            <div class="px-md-5">
              <hr class="line-success">
              <h2><i class="fa fa-pallet"></i>  Editar y Eliminar un articulo </h2>  
            <p>Elige un producto de la tabla de productos  </p>
             <p> Filtraló usando los botones de familias de productos
            También puedes buscarlo con la barra de búsqueda de la tabla 
            </p>
            <p>
            Toca el botón más si la tabla esta comprimida y luego toca el botón <button type="button"   class="boton-editar-articulo btn btn-sm btn-primary"  > <i class="fa fa-spin fa-gear"></i> Editar Datos</button>
            Podrás ver todos los campos del articulo y modificarlos, todos menos la existencia actual en inventario para modificar ese dato es necesario hacerlo mediante un movimiento de inventario. 
            </p>
           
            <p> Para eliminar un articulo solo toca el botón <button type="button" class="btn-eliminar-articulo btn  btn-sm btn-danger" data-id="52"><i class=" fa fa-trash"></i> Borrar</button>, recuerda que al borrar un articulo quedara un hueco que se marcara como «null» en todos los registros vinculados. 
           </p>
            </div>
          </div> 

           <div class="col-md-8 wow fadeInRight" data-wow-duration="3s">
            <img src="sistema/images/imagen_promocional/documentacion/inventarios/articulos/articulos2.png" class="img-fluid floating">
          </div>
