...
<!-- tabs -->
      ...
      <div class="tab-pane fade" id="bolsa" role="tabpanel" aria-labelledby="bolsa-tab">
			...
			<div class="text-right" style="position: fixed;
												...
												z-index:1000;
												">
											<a class="btn btn-primary" href="https://<?php echo $datosEmpresa[0]['mgn'];?>" target="_blank"><i class="fab fa-facebook-messenger"></i> <span class="d-none d-lg-block">Envíanos un mensaje</span>		 </a>
											<a class="btn btn-success" href="https://api.whatsapp.com/send?phone=<?php echo $datosEmpresa[0]['wtsp'];?>" target="_blank"  target="_blank"><i class="fab fa-whatsapp"></i>  <span class="d-none d-lg-block"> Envíanos un mensaje </span>	</a>
											<a class="btn btn-dark" href="https://<?php echo $datosEmpresa[0]['tlg'];?>" target="_blank"><i class="fab fa-telegram"></i> <span class="d-none d-lg-block">Envíanos un mensaje</span>		 </a>
							</div>
				<div class="container">
					<div class="row">
